...
const BrochureModal = ({ isOpen, onClose, program }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const params = new URLSearchParams({
        ...
        program:
          PROGRAMME_LABELS[program] + " (Brochure Downloaded)" ||
          "General (Brochure Downloaded)",
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: "rgba(15, 44, 76, 0.75)",
    ...
    >
      ...
      >
        ...
        <div className="px-8 pt-7 pb-4 flex items-start justify-between">
          <div>
            <h2 className="text-xl font-bold text-[#163A5F]">
              Get the OAVS Brochure
            </h2>
            <p className="text-sm text-gray-500 mt-1">
              Enter your details below and we'll send you the brochure
              instantly.
            </p>
          </div>
          <button
