...
const Internship = ({ navigate, onBrochureDownload }) => (
  <div className="pt-20 min-h-screen bg-white">
    ...
    <div className="relative bg-[#163A5F] text-white py-24 px-4 overflow-hidden">
      <div className="absolute inset-0">
        <img
          ...
          className="w-full h-full object-cover object-[100%_10%] opacity-[0.15]"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <p className="text-blue-100 max-w-2xl text-lg mb-8">
          A structured one-year clinical internship for final-year UG optometry
          students — bridging theory with real-world hospital practice.
        </p>
    ...
    {/* Orange Outcomes Strip */}
    <div className="bg-[#F47B20] text-white py-8 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center items-start">
        <div>
        ...
        <div>
          ...
          <p className="text-3xl font-extrabold mt-2">Rs 25,000/-*</p>
          <p className="text-sm opacity-90 mt-1">
      ...
      <div className="md:col-span-3 space-y-14">
        ...
        <section>
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Ophthall Academy of Vision Sciences offers a{" "}
            <strong>one-year internship in Clinical Optometry</strong> for UG
            students during their fourth and final year of study.
          </p>
          <p className="text-gray-600 text-lg leading-relaxed mt-4">
            The objective of the internship is to make students well-versed in
            clinical procedures &amp; diagnostics, and enable them to perform
            accurate preliminary examination for patients in an eye OPD.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="sm:grid-cols-2 gap-4">
            <CheckItem text="1 Year Duration" />
            <CheckItem text="Online classes by expert faculty members" />
            <CheckItem text="Upto 20,000 Stipend provided during internship For Select Candidates" />
            <CheckItem text="Regular mentor meetings" />
            <CheckItem text="100 Seats Limited Intake Only" />
            <CheckItem text="Postings in well-Recognized & Reputed Eye Hospitals across India For Select Candidate" />
            <CheckItem text="Absorption as staff optometrist on completion With Minimum Salary Rs 25,000/- in reputed eye hospitals For Select Candidates" />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 flex items-start gap-4">
            ...
            <div>
              <p className="font-bold text-[#163A5F] text-lg">
                Academic Requirement
              </p>
              <p className="text-gray-600 mt-1">
                Candidate must have completed{" "}
                <strong>3 years of academic studies in Optometry</strong>{" "}
                (currently in their 4th / final year).
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
            <table className="w-full text-sm">
              <thead className="bg-[#163A5F] text-white">
                <tr>
                  <th className="px-6 py-4 text-left font-bold uppercase tracking-wide">
                    Component
                  </th>
                  <th className="px-6 py-4 text-right font-bold uppercase tracking-wide">
                    Amount
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="bg-orange-50">
                  ...
                  <td className="px-6 py-4 text-right font-black text-[#F47B20] text-base">
                    ₹70,800
                  </td>
                </tr>
              </tbody>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-[#163A5F]">
                    Ophthall Academy of Vision Sciences
                  </p>
                  <p className="text-gray-500 text-sm">
                    A division of Welcare Health Systems Pvt Ltd
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <p className="text-gray-700">
                  No 1252, Golden Colony, Mogappair, Chennai – 600050
                </p>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-blue-50 p-3 rounded-full text-[#163A5F] shrink-0">
      ...
      <div className="md:col-span-2">
        <div className="sticky top-28 space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-[#F47B20]">
            <h3 className="text-xl font-bold text-[#163A5F] mb-6">
              Programme Details
            </h3>
          ...
          <div className="bg-gradient-to-br from-[#163A5F] to-[#0F2C4C] text-white p-6 rounded-2xl shadow-lg">
            <p className="text-xs font-bold uppercase tracking-widest text-[#F47B20] mb-2">
              Career Outcome
            </p>
            <p className="font-bold text-lg leading-snug">
              Absorption as Staff Optometrist in reputed eye hospitals on
              completion
            </p>
          </div>
        </div>
